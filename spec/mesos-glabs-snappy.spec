...
%global commit             7f2e883b7f2b92cb0d575cf4f147405341a50726
%global shortcommit        %(c=%{commit}; echo ${c:0:7})
%global build_qualifier    glabs
%global build_num          build_num
%global jdk_home           @JDK_HOME@
%global jdk_version        @JDK_VERSION@

#./configure:PACKAGE_VERSION='0.15.0'
#%define mesos_ver          @PACKAGE_VERSION@ 
%define mesos_ver           0.15.0
%define rel_ver             +snappy.%{build_qualifier}%{build_num}.%{shortcommit}%{?dist}
...
#automake -a
#autoreconf -vfi
JAVA_HOME=%{java_home} LIBS="${LIBS} -lsnappy"; export LIBS; %configure
%{__make} %{?_smp_mflags}
